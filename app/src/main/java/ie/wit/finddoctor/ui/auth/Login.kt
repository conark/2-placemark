package ie.wit.finddoctor.ui.auth
...
import ie.wit.finddoctor.databinding.LoginBinding
import ie.wit.finddoctor.ui.home.Home
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        Timber.i("Find Doctor Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
